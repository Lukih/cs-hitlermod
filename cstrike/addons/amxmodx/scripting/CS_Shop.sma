...
new g_iInvisibilityLevel[] = { 130, 70, 10 }
...
Create_Menu(id)
{
	new Menu = menu_create("\rEl Tranza", "MainMenu_Handler")
...
public MainMenu_Handler(id, Menu, item)
{
	...
	switch (Key)
	{
		case 0:
		{
			new Cts_Menu = menu_create("\rMenu de armas CT", "CtMenu_Handler")
		...
		case 1:
		{
			new Ts_Menu = menu_create("\rMenu de armas TT", "TeMenu_Handler")
			new Items[32], PriceString[32], Position[3]
		...
		case 2:
		{
			new Inv_Menu = menu_create("\rMenu de invisibilidad", "InvisibilityMenu_Handler")
			new Items[32], PriceString[32], Position[3]
		...
		case 3:
		{
			new Grav_Menu = menu_create("\rMenu de gravedad", "GravityMenu_Handler")
			new Items[32], PriceString[32], Position[3]
		...
		case 4:
		{
			new Hp_Menu = menu_create("\rMenu de vida", "HealthMenu_Handler")
			new Items[32], PriceString[32], Position[3]
		...
		case 5:
		{
			new Speed_Menu = menu_create("\rMenu de velocidad", "SpeedMenu_Handler")
			new Items[32], PriceString[32], Position[3]
		...
		case 6:
		{
			new Skins_Menu = menu_create("\yMenu de skins", "SkinsMenu_Handler")
			new Items[32], PriceString[32], Position[3]
